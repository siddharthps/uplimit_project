...
def main():
    st.set_page_config(page_title="Podcast Insights Hub", page_icon="🎧")
    ...
    # Theme switcher
    theme = sidebar.radio("Select Theme", ["Light", "Dark"])
    if theme == "Light":
        st.set_theme("light")
    else:
        st.set_theme("dark")
    ...
    if selected_podcast:
        ...
        with col2:
            ...
            st.image(podcast_info['podcast_details']['episode_image'], width=400)
